...
void push_stack(komik** head) {
    ...
    *head = temp;
    ...
    clear_screen();
    cout << "Komik berhasil ditambahkan menggunakan cara stack!" << endl;
}
...
void enqueue(komik** head) {
    ...
    clear_screen();
    cout << "Komik berhasil di-enqueue menggunakan cara enqueue!" << endl;
}
...
int main() {
    ...
    while (true) {
        ...
        cout << "2. Push Komik" << endl;
        cout << "3. Enqueue Komik" << endl;
        cout << "4. Tampilkan Komik" << endl;
        cout << "5. Ubah Data Komik" << endl;
        cout << "6. Hapus Komik" << endl;
